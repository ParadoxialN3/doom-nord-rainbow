...
(def-doom-theme doom-nord-aurora
  ...
  ((bg         '("#3B4252" nil       nil            ))
   ...
   (grey       base4)
   (red        '("#E27878" "#ff6655" "red"          )) ;; Nord11
   (orange     '("#E2A478" "#E2A478" "brightred"    )) ;; Nord12
   (green      '("#A3BE8C" "#99bb66" "green"        )) ;; Nord14
   (teal       '("#B4BE82" "#44b9b1" "brightgreen"  )) ;; Nord7
   (yellow     '("#EBCB8B" "#ECBE7B" "yellow"       )) ;; Nord13
   (blue       '("#89B8C2" "#51afef" "brightblue"   )) ;; Nord9
   (dark-blue  '("#84A0C6" "#2257A0" "blue"         )) ;; Nord10
   (magenta    '("#A093C7" "#c678dd" "magenta"      )) ;; Nord15
   (violet     '("#5D80AE" "#a9a1e1" "brightmagenta")) ;; ??
   (cyan       '("#8FBCBB" "#46D9FF" "brightcyan"   )) ;; Nord8
   (dark-cyan  '("#5e81ac" "#5699AF" "cyan"         )) ;; ??
